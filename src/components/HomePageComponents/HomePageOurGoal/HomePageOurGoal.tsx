...
export const HomePageOurGoal: React.FC = () => {
  return (
          ...
          <div className={styles.contentContainer}>
            ...
            <div className={styles.labelsContainer}>
              ...
              <div>
                ...
                <p>
                  ...здоровою та корисною їжею: різноманітними, збалансованими та улюбленими стравами, які приготовані
                  на власній професійній кухні нашими кухарами з турботою та любов&apos;ю.
                </p>
              </div>
            </div>
          </div>
